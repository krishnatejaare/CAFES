...
public class MapsActivity extends FragmentActivity implements
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBbgxNpSsaW6b-wyRbhQirpcobLbgFDjmQ";
    EditText placeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Button btnFind = (Button) findViewById(R.id.Bsearch);
        setUpMapIfNeeded();
...
// Changing action button text color
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.viewlist) {
            ...
            PlacesDisplayTask p = new PlacesDisplayTask();
            List<Record> myList = p.getRecordsnew();

            System.out.println("In maps list is" + myList.size());
    ...
    private void handleNewLocation(Location location) {
        ...
        MarkerOptions options = new MarkerOptions()
                .position(latLng)
                .title("I am here!").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
       ...
       // String cafe="cafe";
        ...
        googlePlacesUrl.append("&types=" + Main2Activity.cafe);
